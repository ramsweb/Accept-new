            ...
            <div class="col-lg-6 align-self-center">
              <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                <div class="row">
                  <div class="col-lg-12">
                    <h6>أكسبت</h6>
                    <h2>التصوير بالفيديو</h2>
                    <p>سواء كنت مهتمًا بإنتاج فيديو تدريبي أو فيديو حدث أو الترويج لسلع أو خدمات معينة ، فنحن على استعداد لمساعدتك في أي من برامج إنتاج الفيديو أو الأحداث الخاصة بك. لدينا المعرفة والخبرة في البرمجة النصية ، وإعداد الصور وإجراء المقابلات أيضًا.</p>
                  </div>
                  <div class="col-lg-12">
        ...
        <div class="col-lg-6 show-up wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
          <div class="blog-post">
            ...
            <div class="down-content">
              ...
              <p>يعد الفيديو الترويجي طريقة فريدة لنقل المعلومات حول منتجات وخدمات شركتك بطريقة مبسطة. إنها طريقة رائعة للترويج لاسم عملك وصورتك. باستخدام الفيديو الترويجي ، يمكنك الوصول إلى عملائك بشكل أفضل من خلال عرض المعلومات التي يحتاجون إليها فور وصولهم إلى موقعك. أظهرت الدراسات أن تسويق الفيديو ناجح للغاية. أبلغت العديد من الشركات عن تحقيق مكاسب كبيرة في حركة المرور على موقع الويب والأعمال التجارية في الشهر الأول بعد تضمين مقطع فيديو على موقعها على الويب. بدلاً من قضاء الوقت في البحث عن منتجاتك وخدماتك ، سيرى زوار موقعك الإلكتروني كل ما تفعله وما يحتاجون إلى معرفته في مقطع فيديو قصير مدته 60 ثانية</p>
            </div>
          </div>
        </div>
        <div class="col-lg-6 show-up wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
          <div class="blog-post">
            <div class="thumb">
              <a href="#"><img src="assets/images/features/Highlight-video-ar.jpg" alt=""></a>
            </div>
            <div class="down-content">
              <a href="#">
                <h4>تسليط الضوء على الفيديو</h4>
              </a>
              <p>توفر مقاطع الفيديو المميزة أيضًا فرصة فريدة للتواصل مع جمهورك المستهدف بطريقة تربطهم بما هو مهم حقًا لهم ، مع زيادة قيمة منتجاتك وحتى علامتك التجارية. يمكنك استخدام تسويق الفيديو بعدة طرق مختلفة ، بما في ذلك عروض المبيعات ، والبرامج التعليمية ، وتسلسلات الإطلاق على موقع الويب الخاص بك ، أو فقط لزيادة الوعي بالعلامة التجارية. كلما زاد عدد الأشخاص الذين يرونك أو يسمعونك ، تزداد سرعة التعرف على علامتك التجارية على الفور. يمكن أن يترك الفيديو انطباعًا دائمًا ، حيث يوفر وسيلة تفاعلية مثالية لرسالتك التسويقية ، ويمكن أن يساعد في ترتيب موقعك على جوجل .</p>
            </div>
          </div>
        </div>
        <div class="col-lg-6 show-up wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
          <div class="blog-post">
            <div class="thumb">
              <a href="#"><img src="assets/images/features/Detail-Video-ar.jpg" alt=""></a>
            </div>
            <div class="down-content">
              <a href="#">
                <h4>تفاصيل الفيديو</h4>
              </a>
              <p>إن أهم تقنية تستخدمها معظم الشركات هي الفيديو التفصيلي بهدف تسويق أعمالها وإبراز منتجاتها أو خدماتها حقًا. يعتبر التسويق عبر الإنترنت تنافسيًا للغاية هذه الأيام ، يعد الفيديو التفصيلي المصمم جيدًا خطوتك الأولى لتظهر للعالم ما يمكن أن يفعله عملك بالضبط ومن أنت. غالبًا ما يُعتبر إنتاج الفيديو التفصيلي بطاقة عملك ، حيث أنه يوفر نظرة عامة على المنتجات أو الخدمات.</p>
            </div>
          </div>
        </div>
