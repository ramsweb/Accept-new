              ...
              <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <p>We utilize social networking sites like Facebook, Twitter, linkedln and other popular social sites with real targeted records and tons of traffic each day as the most befitting medium of intimating the web audience about your services or products. We also utilize other social interactive platforms such as social forums, blogs discussion forums, question-answer forums, and review websites to help businesses derive a genuine online presence.</p>
                  </div>
                  <div class="col-lg-12">
      ...
      <div class="row">
        <div class="col-lg-4 offset-lg-4  wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.3s">
          <div class="section-heading">
            <h6>ACCEPT</h6>
            <h4>Social Media <em>Marketing</em></h4>
